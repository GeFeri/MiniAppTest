    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=40)),
                ('manager', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='managed_departments', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='InviteKey',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='hobbies', to='users.typehobby')),
            ],
        ),
        migrations.CreateModel(
            name='UserHobby',
            fields=[
                ...
                ('hobby', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='users.hobby')),
        ...
        migrations.AddField(
            model_name='user',
            name='hobbies',
            field=models.ManyToManyField(related_name='users', through='users.UserHobby', to='users.hobby'),
        ),
    ]
